CLASSES = {'pascal': ['background', 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus',
           ...
           'synapse': ['background', 'Spleen', 'Right kidney', 'Left kidney', 'Gallbladder', 'Esophagus', 'Liver',
                       'Stomach', 'Aorta', 'Inferior vena cava', 'Portal vein and splenic vein',
                       'Pancreas', 'Right adrenal gland', 'Left adrenal gland'],
           'mnms': ['background', 'left ventricle', 'left ventricular myocardium', 'right ventricle'],
           'mmwhs': ['background', 'AA', 'LAC', 'LVC', 'MYO'],
            'la': ['background', 'Left Atrium'],
